#!/usr/bin/env python3
"""
Run ByteTrack inference on DCNv3 models with video output
...
def main():
    print("="*70)
    print("DCNv3 BYTETRACK - TRACKING METRICS")
    print("="*70)

    VIDEO_DIR = Path("/media/mydrive/GitHub/ultralytics/videos")
    OUTPUT_BASE_DIR = "/media/mydrive/GitHub/ultralytics/tracking/inference_dcnv3_tracking"
    ...
    for model_dir in model_dirs:
        ...
        if weights_file.exists():
            ...
            if 'fpn' in dir_name:
                ...
                name = "DCNv3-Full"
            elif 'liu' in dir_name:
                name = "DCNv3-Liu"
            elif 'pan' in dir_name:
                name = "DCNv3-Pan"
            else:
                name = Path(model_dir).name
            models.append((str(weights_file), name))
