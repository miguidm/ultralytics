...
VIDEO_PATH  = '/media/mydrive/GitHub/ultralytics/videos/6to6_g29.mp4'
OUTPUT_DIR  = '/media/mydrive/GitHub/ultralytics/tracking/video_g29_1hr'
FPS_VIDEO   = 15
...
def run(model_path, model_name):
    print(f"\n{'='*65}")
    print(f"  {model_name}  |  6to6_g29.mp4  |  first 1 hour")
    print(f"{'='*65}")
    ...
    out_path  = os.path.join(OUTPUT_DIR, f"{model_name}_g29_1hr.mp4")
