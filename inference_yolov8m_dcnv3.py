#!/usr/bin/env python3
"""
YOLOv8m DCNv3 Inference Script with Tracking and Counting
Based on inference_dcnv2.py - Uses ByteTrack for vehicle detection and counting

Model: 100_dcnv3_yolov8m_liu_second
- mAP50: 90.1%
- mAP50-95: 76.1%
- Precision: 93.6%
- Recall: 80.2%
...
Usage:
    python inference_yolov8m_dcnv3.py --model <model_path> --source <video_path> --output <output_path>

Example:
    python inference_yolov8m_dcnv3.py --model weights/best.pt --source input.mp4 --output output.mp4
"""
...
# Setup environment BEFORE any torch imports
os.environ['LD_LIBRARY_PATH'] = '/home/migui/miniconda3/envs/dcn/lib/python3.10/site-packages/torch/lib'
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='YOLOv8m DCNv3 Inference with Tracking')
    parser.add_argument('--model', type=str,
                        default='/home/migui/YOLO_outputs/100_dcnv3_yolov8m_full_second/weights/best.pt',
                        help='Path to YOLOv8m DCNv3 model weights')
    parser.add_argument('--source', type=str,
                        default='/media/mydrive/GitHub/ultralytics/videos/Gate2.9_Oct7.mp4',
...
def main():
    ...
    if args.output is None:
        model_name = Path(args.model).parent.parent.name  # Get model directory name
        args.output = f"{model_name}_output.mp4"

    print("="*70)
    print("YOLOv8m DCNv3 Inference with ByteTrack")
    print("="*70)

    # Load YOLOv8m DCNv3 model
    ...
    while True:
        ...
        # Run YOLOv8m-DCNv3 tracking with ByteTrack
        ...
        cv2.putText(extended_frame, "[YOLOv8m DCNv3]", (frame_width + 10, 55),
        ...
        if not args.no_display:
            cv2.imshow("YOLOv8m DCNv3 + ByteTrack", extended_frame)
    ...
    output_content = f"""YOLOv8m DCNv3 Inference with ByteTrack - Metrics Report
================================================================

Model Configuration:
- Model Path: {args.model}
- Model Name: 100_dcnv3_yolov8m_liu_second
- Model Performance:
  * mAP50: 90.1%
  * mAP50-95: 76.1%
  * Precision: 93.6%
...
Vehicle Counts (Diagonal Line Crossing):
-----------------------------------------
